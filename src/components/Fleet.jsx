...
const vehicles = [
  ...
  {
    id: 12, category: 'Heavy',
    name: '6 wheel lorry',
    subtitle: 'Heavy',
    capacity: '15 Ton',
    image: '/images/fleet/6wheel.jpeg',
    badge: 'Heavy',
    badgeColor: 'bg-orange-100 text-orange-700',
